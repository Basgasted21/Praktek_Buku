    ...
    <div class="container">
        <form action="proses-edit.php" method="post">
            <fieldset>
                ...
                <div class="mb-3">
                    <label for="iJudul_buku" class="form-label mt-3">Judul Buku</label>
                    <input type="text" name="iJudul_buku" class="form-control" placeholder="Judul buku..." value=" <?php echo $buku['judul_buku']; ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="iTahun_terbit" class="form-label mt-3">Tahun terbit Buku</label>
